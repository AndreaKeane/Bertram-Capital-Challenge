package com.andrea.tabs.service;
...
public class TabService {
    ...
    public static Tab createTab(Tab tab) throws InstanceAlreadyExistsException {
    ...
    public static Tab readTab(String id) throws InstanceNotFoundException {
        Tab tab = TABS.get(id);
    ...
    public static Tab updateTab(Tab tab) {
        TABS.replace(tab.id(), tab);
        return tab;
    }

    // DELETE a Tab instance in our in-memory `tabs` map
    public static Tab deleteTab(String id) {
